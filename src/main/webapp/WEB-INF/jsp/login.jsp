...
<div id="status">
	...
	<form  action="/login" method="post" >
		<div class="lc-block">
			...
			<div>
				<input type="password" class="style-4" name="password" placeholder="Password" id="password" onfocus="clearThis(this)" />
			</div>
			<div>
				<input type="submit" value="Sign In" class="button red small" id="btlog"/>
